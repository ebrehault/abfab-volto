...
function create_fragment(ctx) {
	...
	return {
		c() {
			pa_checkbox = element_1("pa-checkbox");
			div1 = element_1("div");
			div0 = element_1("div");
			...
			attr(input, "aria-checked", input_aria_checked_value = !!/*element*/ ctx[8] && /*element*/ ctx[8].checked);
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*element*/ 256 && input_aria_checked_value !== (input_aria_checked_value = !!/*element*/ ctx[8] && /*element*/ ctx[8].checked)) {
