...
function add_css() {
	...
	style.id = "svelte-1la5d8o-style";
	style.textContent = "main.svelte-1la5d8o>div.svelte-1la5d8o{padding:0 0 1em 1em}.drop-zone.svelte-1la5d8o.svelte-1la5d8o{margin-top:4em;position:relative;border:1px dashed var(--color-neutral-secondary-default);text-align:center;height:30vh}.upload-field.svelte-1la5d8o.svelte-1la5d8o{display:block;width:100%;height:30vh;opacity:0;position:absolute;top:0}.add.svelte-1la5d8o.svelte-1la5d8o{padding-top:1em}";
	append(document.head, style);
}

// (53:16) <AFButton size="small" kind="primary" on:click={add}>
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			t6 = space();
			input = element("input");
			attr(div1, "class", "add svelte-1la5d8o");
			attr(div2, "class", "svelte-1la5d8o");
			attr(input, "class", "upload-field svelte-1la5d8o");
			attr(input, "type", "file");
			input.multiple = true;
			attr(div3, "class", "drop-zone svelte-1la5d8o");
			attr(div4, "class", "svelte-1la5d8o");
			attr(main, "class", "svelte-1la5d8o");
		},
		m(target, anchor) {
...
class Component extends SvelteComponent {
	constructor(options) {
		super();
		if (!document.getElementById("svelte-1la5d8o-style")) add_css();
